...
--removes duplicates in result set
SELECT DISTINCT song_name FROM songs;

--Display song name and length where length is more than 2 mins and genre is opm
...
--Delete all opm songs that are equal or more than 2 mins
